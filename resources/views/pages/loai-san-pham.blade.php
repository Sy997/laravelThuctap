        ...
        <div class="row">
          <div class="col-main col-sm-9 col-xs-12 col-sm-push-3">
            ...
            <div class="shop-inner">
                      ...
                      <div class="item-inner">
                        ...
                        @if ($loai->promotion_price !=0)
                          ...
                          <div class="pr-img-area">
                            <a title="Ipsums Dolors Untra" href="{{route('chi-tiet-sp',$loai->id)}}">
                              <figure>
                                <img class="first-img" src="main/images/products/{{$loai->image}}" alt="">
                                <img class="hover-img" src="main/images/products/{{$loai->image}}" alt="">
                              </figure>
                            </a>
                            <a href="{{route('themgiohang',$loai->id)}}">
                        ...
                        <div class="item-info">
                          <div class="info-inner">
                            <div class="item-title">
                              <a title="Ipsums Dolors Untra" href="{{route('chi-tiet-sp',$loai->id)}}">{{$loai->name}} </a>
                            </div>
                              ...
                              <div class="item-price">
                                ...
                                @if ($loai->promotion_price==0)
                                        <span class="regular-price">
                                          <span class="price">{{$loai->price}}</span>
                                        </span>
                                      @else
                                      <p class="special-price">
                                          <span class="price-label">Special Price</span>
                                          <span class="price">{{$loai->promotion_price}}</span>
                                        </p>
                                        <p class="old-price">
              ...
              <div class="pagination-area ">
                <div class="row">{{$loai_sp->links()}}</div>
              </div>
            </div>
          </div>
          <aside class="sidebar col-sm-3 col-xs-12 col-sm-pull-9">
            ...
            <div class="block sidebar-cart">
              <div class="sidebar-bar-title">
                <h3>Gio hang cua toi</h3>
              </div>
              @if(Session::has('cart'))
              <div class="block-content">
                <p class="amount">Da co 
                  <a href="shopping_cart.html">{{Session('cart')->totalQty}} san pham </a> trong gio hang</p>
                <ul>
                @foreach($productCart as $products)
                  <li class="item">
                    <a href="shopping_cart.html" title="Sample Product" class="product-image">
                      <img src="main/images/products/{{$products['item']['image']}}" alt="Sample Product ">
                    </a>
                    <div class="product-details">
                      <p class="product-name">
                        <a href="shopping_cart.html">{{$products['item']['name']}}</a>
                      </p>
                      <strong>{{$products['qty']}}</strong>x 
                      <span class="price">{{number_format($products['price']/$products['qty'])}}</span>
                    </div>
                  </li>
                @endforeach
                ...
                <div class="summary">
                  <p class="subtotal">
                    ...
                    <span class="price">{{ number_format(Session('cart')->totalPrice)}}</span>
                  </p>
                </div>
                <a href="{{route('dat-hang')}}">
