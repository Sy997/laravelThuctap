      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  <li>
                      <a class="active" href="{{route('home-admin')}}">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a  href="{{route('getuser')}}">Danh sách</a></li>
                          <li><a  href="{{route('addUser')}}">Thêm</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a  href="{{route('getslide')}}">Danh sách</a></li>
                          <li><a  href="{{route('addSlide')}}">Thêm</a></li>
                      </ul>
                  </li>
                  <li>
