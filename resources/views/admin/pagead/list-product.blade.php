                    ...
                    <tbody>
                     @foreach($products as $product)
                      ...
                      <td>SP000{{$product->id}}</td>
                        ...
                        <td>
                            <button class="btn btn-danger btn-sm updateProduct" data-toggle="modal" data-target="#myModal" data-id="{{$product->id}}">Xoá</button>
                            @if(Auth::user()->role=='admin')
                            <a href="{{route('updateProduct',$product->id)}}"><button class="btn btn-Success btn-sm">Sửa</button></a>
                            @endif
                        </td>
                      </tr>
                      @endforeach
